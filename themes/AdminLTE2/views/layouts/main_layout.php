...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo $baseUrl; ?>/index2.html" class="logo">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo $baseUrl; ?>/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="<?php echo $baseUrl; ?>/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li><a href="<?php echo $baseUrl; ?>/documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
...
<!-- jQuery 2.2.0 -->
<script src="<?php echo $baseUrl; ?>/plugins/jQuery/jQuery-2.2.0.min.js"></script>
<!-- Bootstrap 3.3.6 -->
